...
def greedy_algorithm(max_amount=0):
    """
        Sort actions by profit Then again the most profitable action possible
        for the remaining amount until reaching the maximum amount or no more action possible
